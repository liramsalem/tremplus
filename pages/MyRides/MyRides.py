...
def index():
    ...
    # participents_details_for_email = db_Drives.find_participents_name_email(42);
    # print(participents_details_for_email)
    # print(participents_details_for_email[0])
    # drive_details_for_email = db_Drives.find_drive_details(42);
    # print(drive_details_for_email)
    # print(len(participents_details_for_email))
    # for i in range(len(participents_details_for_email)):
    #     print('try')
    #     print(participents_details_for_email[i].Fname, participents_details_for_email[i].Lname,
    #               participents_details_for_email[i].user_email)
