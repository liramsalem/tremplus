...
def index():
    ...
    # participents_details_for_email = db_Drives.find_participents_name_email(31);
    # drive_details_for_email = db_Drives.find_drive_details(31);
    # print(participents_details_for_email)
    # print(drive_details_for_email)
    # print(len(participents_details_for_email))
    # for i in participents_details_for_email:
    #     print('try')
    if request.method == 'POST':
        ...
        if request.form['req'] == "remove_passenger":
                ...
                # print(drive_details_for_email)
                # sendEmail(driver_details_for_email[1],driver_details_for_email[2],driver_details_for_email[0],f"נוסע נמחק מנסיעה החלה בתאריך {drive_details_for_email[2]} בשעה {drive_details_for_email[3]} מ- {drive_details_for_email[0]} ל- {drive_details_for_email[1]}")
        ...
        if request.form['req'] == "remove_drive":
            ...
            #           f"שימ/י לב!, הנסיעה מ-  {drive_details_for_email[0]} ל- {drive_details_for_email[1]} ב- {drive_details_for_email[2]} בשעה {drive_details_for_email[1]} התבטלה. ")
